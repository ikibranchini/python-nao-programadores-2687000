...
total_dias = input('Qual o total de dias que você irá dedicar a esse estudo?')
# 3. Crie uma variável chamada "total_horas" e, usanod o método input(), solicite a média de horas estudada por dia;
total_horas = input('Qual o total de horas que você irá dedicar a esse estudo?')
...
print(f'Olá {nome}, você costuma estudar {total_dias} dias por semana, durante mais ou menos {total_horas} horas diárias. Isso significa que você estuda em média {total_dias/total_horas} por semana para o curso de {curso}!')